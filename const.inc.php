...
const cItemsWhereClause = '(`name` LIKE "VIP _ %" OR `name` LIKE "VIP _.5 %" OR `name` LIKE "Donor %" OR `name` LIKE "|cffff0000*VIP _ %") AND `name` NOT LIKE "VIP _ Haste GEM" and `name` NOT LIKE "V__ 9 %"';

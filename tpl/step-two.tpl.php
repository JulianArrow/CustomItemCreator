	...
	<div class="form-group" id="primary-stats">
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="stamina-plus" disabled>+ <span class="amount"><?=stats['7']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="strength-plus" disabled>+ <span class="amount"><?=stats['4']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="intellect-plus" disabled>+ <span class="amount"><?=stats['5']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="agility-plus" disabled>+ <span class="amount"><?=stats['3']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="spirit-plus" disabled>+ <span class="amount"><?=stats['6']['amount']?></span></button>
			</div>
	...
	<div class="form-group" id="secondary-stats">
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="haste-plus" disabled>+ <span class="amount"><?=stats['36']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="parry-plus" disabled>+ <span class="amount"><?=stats['14']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="hit-plus" disabled>+ <span class="amount"><?=stats['31']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="crit-plus" disabled>+ <span class="amount"><?=stats['32']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="dodge-plus" disabled>+ <span class="amount"><?=stats['13']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="defense-plus" disabled>+ <span class="amount"><?=stats['12']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="block-plus" disabled>+ <span class="amount"><?=stats['15']['amount']?></span></button>
			</div>

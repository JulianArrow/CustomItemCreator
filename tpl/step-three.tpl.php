	...
	<div class="form-group" id="penetration">
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="armor-pen-plus" disabled>+ <span class="amount"><?=stats['44']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="spell-pen-plus" disabled>+ <span class="amount"><?=stats['47']['amount']?></span></button>
			</div>
	...
	<div class="form-group" id="weapon">
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="weapon-spe-plus" disabled>+ <span class="amount"><?=stats['B']['amount']?></span></button>
			</div>
			...
			<div class="input-group-append">
				<button class="btn btn-outline-secondary" type="button" id="weapon-spe-minus" disabled>-</button>
			</div>
		</div>
		<!-- Weapon Damage -->
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="weapon-dmg-plus" disabled>+ <span class="amount"><?=stats['A']['amount']?></span></button>
			</div>
	...
	<div class="form-group" id="resilience-stat">
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="resilience-plus" disabled>+ <span class="amount"><?=stats['35']['amount']?></span></button>
			</div>
	...
	<div class="form-group" id="power">
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="attack-power-plus" disabled>+ <span class="amount"><?=stats['38']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="spell-power-plus" disabled>+ <span class="amount"><?=stats['45']['amount']?></span></button>
			</div>
	...
	<div class="form-group" id="expertise-stats">
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="expertise-plus" disabled>+ <span class="amount"><?=stats['37']['amount']?></span></button>
			</div>
	...
	<div class="form-group" id="armor-stats">
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="armor-plus" disabled>+ <span class="amount"><?=stats['F']['amount']?></span></button>
			</div>
	...
	<div class="form-group" id="magic-resistance">
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="magic-res-plus" disabled>+ <span class="amount"><?=stats['G']['amount']?></span></button>
			</div>
	...
	<div class="form-group" id="gem-slots">
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="reg-gem-plus" disabled>+ <span class="amount"><?=stats['C']['amount']?></span></button>
			</div>
		...
		<div class="input-group input-group-sm">
			<div class="input-group-prepend">
				...
				<button class="btn btn-outline-secondary" type="button" id="meta-gem-plus" disabled>+ <span class="amount"><?=stats['D']['amount']?></span></button>
			</div>
